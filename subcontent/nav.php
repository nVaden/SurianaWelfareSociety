...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <?php
  echo '<a href="'.$defaulturl['home'].'/index.php" class="w3-bar-item w3-button w3-teal"><i class="fa fa-home w3-margin-right"></i>Suriana Welfare Society Of Malaysia</a>
        <a href="'.$defaulturl['home'].'/index.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">What We Do</a>
