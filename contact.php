...
<body>
  ...
  <div class="w3-container">
   ...
   <div class="w3-container w3-padding-64 w3-theme-l5" id="contact">
    <div class="w3-row">
      <div class="w3-col m5">
        <div class="w3-padding-16" style="padding-left:40px"><span class="w3-xxlarge w3-border-teal w3-bottombar">Contact Us</span></div>

        <!-- Team Container -->
        <div class="w3-container w3-padding-54 w3-center" id="team" style="">
          <h1>OUR TEAM</h1>
          ...
          <div class="w3-row"><br>
            ...
            <div class="w3-third">
              <a href="james.php">
                <img src="assets/images/james.jpg" style="width:60%" class=" w3-hover-opacity"></a>
                <h3>James Nayagam</h3>
                <p>Chairman</p>
              </div>
              ...
              <div class="w3-third">
               <a href="scott.php">
                <img src="assets/images/scott.jpg" style="width:75%" class=" w3-hover-opacity"></a>
                <h3>Scott J Wong</h3>
              ...
              <div class="w3-third">
               <a href="jeffrey.php">
                <img src="assets/images/jeffrey.jpg" style="width:75%" class=" w3-hover-opacity"></a>
                <h3>Jeffrey Tay</h3>
